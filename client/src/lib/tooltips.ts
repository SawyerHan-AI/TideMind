...
const t = (key: string) => i18n.t(key, { ns: 'tooltips' })

function i18nTipRecord(prefix: string, keys: string[]): Record<string, string> {
...
export const GATE_OVERVIEW_TIP = (): string => t('gateOverview')
