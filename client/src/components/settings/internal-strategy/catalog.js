...
export function classifyParam(key) {
    if (TRIGGER_PARAM_KEYS.has(key))
        return 'trigger';
    if (LLM_PARAM_KEYS.has(key))
        return 'llm';
    return 'param';
}
// ============================================================
...
export const THINK_ASSOCIATE_NODES = [
    {
        id: 'link-discover',
...
export const THINK_EMERGE_NODES = [
    {
        id: 'keystone',
...
export const TRIGGER_ICONS = {
    realtime: _jsx(Zap, { size: 9 }),
    interval: _jsx(Clock, { size: 9 }),
    query: _jsx(Zap, { size: 9 }),
    event: _jsx(Zap, { size: 9 }),
};
